...
export function Hero() {
  const { t, transLoading } = useLanguage();
  const { settings, loading: settingsLoading } = useSettings();

  if (transLoading || settingsLoading) return <HeroSkeleton />;
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="shrink-0">
            <div className="relative w-48 h-48 sm:w-72 sm:h-72 lg:w-80 lg:h-80">
              <motion.div
                ...
                style={{
                  background:
                    "radial-gradient(circle, #fff 0%, #6366f1 40%, transparent 70%)",
                }}
              ...
              <div className="absolute inset-0 rounded-full overflow-hidden">
                <motion.div
                  ...
                  style={{
                    background:
                      "conic-gradient(from var(--angle), #fff, #6366f1, #06b6d4, #fff)",
                  }}
              ...
              <motion.div
                ...
                style={{
                  background:
                    "conic-gradient(from var(--angle), #fff 0%, #6366f1 30%, transparent 70%)",
                  left: "50%",
                  top: "50%",
                  x: "-50%",
                  y: "-50%",
                ...
                animate={
                  { "--angle": "360deg", scale: [1, 1.15, 0.9, 1] } as any
                }
                transition={{
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    ...
                    fallback.className =
                      "absolute inset-0 rounded-full bg-surface flex items-center justify-center";
                    fallback.innerHTML =
                      '<span class="material-symbols-outlined text-6xl text-text/30">person</span>';
          ...
          <div className="text-center lg:text-left w-full lg:max-w-xl">
            ...
            <p className="text-xl text-text/60 mb-2">
              {t("hero.role")}{" "}
              <a
                href={settings.linkedin_company}
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary font-medium hover:text-accent transition-colors"
              >
                {settings.jdk_link_text}
              </a>
            </p>
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center lg:justify-start">
              ...
              <a
                href={settings.linkedin_personal}
                target="_blank"
                rel="noopener noreferrer"
